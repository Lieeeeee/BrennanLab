...
import org.brennanlab.imagej.graphcuts.GraphCutSegmenter;
import org.brennanlab.imagej.util.levelsets.ImplicitShape2D;
import org.brennanlab.imagej.util.levelsets.ShapePrior;
import org.brennanlab.imagej.util.stochastic.GaussianMixture;
import org.brennanlab.imagej.util.stochastic.IntensityModel;
import org.brennanlab.imagej.util.stochastic.LaplaceMixture;
import org.brennanlab.imagej.util.stochastic.MonotonicFrontSpeedField;
...
public class WaveFrontTracker implements PlugInFilter {
    ...
    public void run(ImageProcessor ip) {
                ...
                try {
                    ...
                    while (true) {
                        ...
                        IJ.log("\t     Iter " + mmIter + " Elapsed time: "
                                ...
                                + " ms" + " Flow " + newEnergy);
                        if ( (Math.abs(oldEnergy - newEnergy) < 1 && mmIter>1  )  || Double.isNaN(oldEnergy)
        ...
        float[][] speedlist = runningSpeed.listArrivalTimes();
        ...
        for(int i=0; i<speedlist.length;i++){
            ...
            rt.addValue("time",speedlist[i][2]);
        }
        rt.show("FrontArrivals");
