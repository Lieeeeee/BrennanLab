...
public class fastMarchingSolver {
	...
	private GenericLevelSet initial; // Initial location at t=0;
	// Default parameters
	...
	public fastMarchingSolver(GenericLevelSet initial){
	 ...
	 * @param spd
	 */
	public fastMarchingSolver(GenericLevelSet initial, float[][] spd) {
		this.setInitial(initial);
		this.spd=spd;
		reset();
	...
	public GenericLevelSet maskToLevelSet(DeferredByteArray2D mask){
		...
		return new GenericLevelSet(boolMask);
	}
	 ...
	 */
	public GenericLevelSet solveAndReturnSignedDistance(double time){
	...
	public void setInitial(GenericLevelSet initial) {
		this.initial = initial;
	}


	public GenericLevelSet getInitial() {
		return initial;
	}
