...
public class SpeedField {
    ...
    ArrayList<GenericLevelSet> wavePositions;
     ...
     * 
     * @param width
     *            Width of interpolation signedDistance
     * @param height
     *            Width of height signedDistance
     **/
	...
	this.wavePositions = new ArrayList<GenericLevelSet>();
     ...
     * 
     * @param arrivals
     *            The arrival times with null for not-defined
     * @param r
     * @param time
     */
    public void addArrival(GenericLevelSet thisLevelset) {
	...
	if (wavePositions.size() == 0) {
	    ...
	    GenericLevelSet prevLevelset = wavePositions.get(wavePositions
		    .size() - 1);
		...
		for (int y = 0; y < height; y++) {
			...
			this.arrivalTimes[x][y] = (-this.wavePositions.size()
     ...
     * @return
     */
    public float[] getCenter(GenericLevelSet signedDistance) {
    ...
    public float[][] interpolateArrivalsFromLevelsets(
	    ArrayList<GenericLevelSet> levelsetSignedDistances) {
